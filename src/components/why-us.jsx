...
export const WhyUs = () => {
    return (
        <>
            <main className="margin spacing space-y-5">
                <div className="flex md:flex-row flex-col gap-2">
                    ...
                    {whyUs.map((item, index) => {
                        ...
                        return (
                            <div key={index} className="hidden md:flex flex-col p-4 bg-lightColor dark:bg-darkColor rounded-main gap-3 flex-1">
            ...
            <div className="md:hidden flex carousel w-full gap-2">
                {whyUs.map((item, index) => {
                    const Icon = item.icon;
                    return (
                        <div key={index} className={`${index === 0 && "ml-4"} ${index === whyUs.length - 1 && "mr-4"} aspect-square min-w-70 flex flex-col p-4 bg-lightColor dark:bg-darkColor rounded-main gap-3 flex-1`}>
                            <div className="bg-radial from-transparent to-neutral-300 dark:to-secondaryDark w-fit h-fit p-3 rounded-full mb-20">
                                <Icon className="text-primary text-4xl flex-shrink-0 " />
                            </div>
                            <div className="flex flex-col items-start">
                                <h3 className="text-lg font-semibold mb-2">
