        ...
        <>
            <div className={`${isScrolled ? "" : "mt-0"} navbar fixed 2xl:px-80 md:px-24 w-full z-[100] ease-in-out duration-300 text-[14px] md:flex justify-center gap-2 hidden `}>
                <li className='relative flex flex-col items-center group'>
                    <Link
                        href={'/'}
                        className={`shadow-custom bg-secondaryLight/65 dark:bg-darkColor/50 backdrop-blur-sm z-[555] flex items-center -ml-[11px] p-[5px] pr-2 text-gray-800 dark:text-white rounded-main hover:bg-darkColor/5 dark:hover:bg-lightColor/5 duration-200 ease-in-out`}
                        aria-current="page"
                    >
                        <Image
                            width={30}
                ...
                <div className="px-1 relative navbar-center hidden lg:flex">
                    ...
                    {/* Wrapper */}
                    <div className={`absolute backdrop-blur-xs px-24 py-5 dark:bg-secondaryDark/50 bg-secondaryLight/65 border border-neutral-300/10 rounded-main w-full h-[35px] -z-[100] top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 shadow-custom`}></div>
